  ...
  return (
    <>
      <Container fluid className="d-flex flex-column p-0">
        <Container
          fluid
          className=" w-100 d-flex flex-column justify-content-between py-5 align-items-center"
          style={{
        ...
        >
          <Row className="w-100 d-flex justify-content-center">
            ...
            <Row className="mt-5">
              ...
              <Col className="text-center">
                <span>
                  Nombre: <br /> {userInfo.name}{" "}
                </span>
              </Col>
              <Col className="text-center">
                <span>
                  Celular: <br /> {userInfo.phone}{" "}
                </span>
              </Col>
              <Col className="text-center">
                <span>
                  Correo: <br /> {userInfo.email}{" "}
                </span>
              </Col>
              <Col className="text-center">
                <LinkContainer to={`/editProfile/${userInfo._id}`}>
        ...
        >
          <Row
            ...
            md={2}
            lg={3}
            className="g-5 mb-5 d-flex justify-content-center align-items-center"
          >
            {favorites.map((house) => (
              <Col
                key={house._id}
