...
const EditProfileScreen = () => {
  ...
  const { data: user, isLoading, refetch, error} =
  ...
  return (
    <>
      ...
      <span className='ms-5 mb-5'>Nota: Unicamente los datos ingresados seran modificados</span>
